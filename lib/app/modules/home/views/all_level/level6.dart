...
class Level6 extends GetView<answer_controller> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image(
                    image: AssetImage("assets/images/VOC.jpg"),
                    height: 140,
                  ),
                  SizedBox(
                    height: 20,
            ...
            Container(
              ...
              child: TextButton(
                ...
                child: Text(
                  "Nederlands West-Indische Compagnie",
                  style: GoogleFonts.roboto(
                    color: Colors.black,
                    fontSize: 13,
                    fontWeight: FontWeight.bold,
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  if (_databasecontroller.leveldata[0].data['currentlevel'] < 7) {
                    _databasecontroller.updateDocument(
                        _databasecontroller.leveldata[0].$id,
                        {'currentlevel': 7, 'detail': 0});
                  }
